            ...
            <main class="p-6  gap-6">
                <div class="flex gap-4">
                    <div class="flex flex-1 flex-col rounded-lg border border-zinc-300 p-6 gap-6">
                        ...
                        <div>
                            <h5 class="font-heading-5 font-semibold text-zinc-800">12 Siswa</h5>
                    ...
                    <div class="flex flex-1 flex-col rounded-lg border border-zinc-300 p-6 gap-6">
                        ...
                        <div>
                            <h5 class="font-heading-5 font-semibold text-zinc-800">12 Guru</h5>
                    ...
                    <div class="flex flex-1 flex-col rounded-lg border border-zinc-300 p-6 gap-6">
                        ...
                        <div>
                            <h5 class="font-heading-5 font-semibold text-zinc-800">12 Surat</h5>
