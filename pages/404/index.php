...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Sistem Pelanggaran</title>
...
<body class="bg-zinc-100 min-h-screen flex items-center justify-center p-6 font-sans">
    ...
    <div class="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative flex justify-center">
            <div class="absolute -top-10 -left-10 w-32 h-32 bg-blue-400 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-pulse"></div>
            <div class="absolute -bottom-10 -right-10 w-32 h-32 bg-purple-400 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-pulse transition-delay-2000"></div>
            <div class="float-animation">
                <h1 class="text-[180px] font-black text-transparent bg-clip-text bg-linear-to-br from-blue-600 to-indigo-900 leading-none select-none">
                    404
                </h1>
            </div>
        </div>
        ...
        <div class="space-y-8 text-center md:text-left">
            <div class="space-y-2">
                <h2 class="text-4xl font-bold text-zinc-900 leading-tight">Waduh! Halaman Hilang</h2>
                <p class="text-lg text-zinc-600">Sepertinya halaman yang kamu cari sudah pindah atau memang tidak pernah ada. Santai dulu, mari balik ke jalan yang benar.</p>
            </div>
